...
- [KemdiCode MCP v3: Lorenz-Inspired Context Compaction for AI-Assisted Software Engineering (PDF)](whitepaper-kemdicode-mcp-v3.0.pdf) — IEEE journal-style paper with Lorenz context compaction, formal specifications, 23 equations, 23 references
