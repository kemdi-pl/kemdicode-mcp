  ...
  orchestrate: z
    .object({
      agent: z
        ...
        .default('plan')
        .describe('Agent type for the agentic loop'),
      maxIterations: z
        .number()
        .min(1)
        .max(30)
      ...
      allowedTools: z
        .array(z.string())
        .optional()
        .describe('Whitelist of tools the agent may call (empty = all)'),
      blockedTools: z
        .array(z.string())
        .optional()
        .describe('Blacklist of tools the agent must not call'),
      enableCognition: z
        .boolean()
        .default(false)
      ...
      boardId: z
        .string()
        .optional()
        .describe('Kanban board ID for recording findings as tasks'),
    })
    .optional()
