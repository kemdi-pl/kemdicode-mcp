...
Respond with ONLY a valid JSON object — no markdown, no XML, no explanation:
{
...
---
After your response above, output a quality assessment on the LAST LINE as a JSON object (no XML, no other text on that line):
