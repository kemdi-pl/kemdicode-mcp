/**
 * KemdiCode MCP Server - Structured Output Module
 * Copyright (C) 2025-2026 Kemdi Sp. z o.o. (Dawid Irzyk <dawid@kemdi.pl>)
 *
 * Provides deterministic JSON output from LLMs using Zod schemas.
 * Combines the jsonrepair utility with schema validation for robust
 * LLM output parsing.
 *
 * @license GPL-3.0
 * @module ai/structured-output
 */
