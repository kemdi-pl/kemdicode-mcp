/**
 * KemdiCode MCP Server - Prompt Enhancer
 * Copyright (C) 2025-2026 Kemdi Sp. z o.o. (Dawid Irzyk <dawid@kemdi.pl>)
 *
 * "First Step" mechanism: analyzes vague user prompts with a cheap/fast LLM,
 * detects missing context, loads relevant files, and rewrites the prompt
 * into a clear, actionable instruction before sending to the target model.
 *
 * @license GPL-3.0
 * @module ai/prompt-enhancer
 */
...
const MODEL_CASCADE: Array<{ envKey: string; model: string; label: string }> = [
  ...
  { envKey: 'GOOGLE_API_KEY', model: 'g:gemini-2.0-flash', label: 'gemini' },
