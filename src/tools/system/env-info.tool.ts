...
export const envInfoTool: UnifiedTool = {
  name: 'env-info',
  description: 'Show environment info: runtimes, languages, tools, OS, hardware. Use when: debugging environment issues or checking available runtimes.',
  zodSchema: schema,
  ...
  metadata: {
    ...
    relatedTools: ['memory-usage', 'tool-health'],
  },
  execute: async (args) => {
