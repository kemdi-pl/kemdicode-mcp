...
const AI_TOOL_NAMES = [
  ...
  'semantic-search',
  'multi-prompt', 'consensus-prompt', 'enhance-prompt', 'ai-models',
];

export const toolHealthTool: UnifiedTool<typeof schema> = {
  name: 'tool-health',
  description: 'Check availability of all tools, including AI provider status. USE PROACTIVELY: check after errors to verify tool availability and AI provider status.',
  zodSchema: schema,
  metadata: {
    category: 'system',
