...
export const taskCreateTool: UnifiedTool = {
  name: 'task-create',
  description: 'Batch create 1-20 tasks on Kanban board. USE PROACTIVELY: break down complex tasks into trackable items.',
  zodSchema: schema,
  metadata: {
    category: 'kanban',
  ...
  execute: async (args): Promise<string> => {
    ...
    return executeWithGuard('task-create', 'kanban-operations', async () => {
