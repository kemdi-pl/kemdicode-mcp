...
const schema = z.object({
  ...
  fileType: z
    .string()
    .optional()
    .describe('File type filter (e.g. "ts", "php") or glob pattern (e.g. "*.tsx"). Similar to language param in find-definition'),
...
export const findReferencesTool: UnifiedTool = {
  ...
  description:
    ...
    'Use when: before renaming or removing a symbol to understand its impact.',
  zodSchema: schema,
  ...
  metadata: {
    ...
    relatedTools: ['find-definition', 'semantic-search'],
  },
