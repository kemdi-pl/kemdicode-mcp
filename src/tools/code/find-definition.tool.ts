...
export const findDefinitionTool: UnifiedTool = {
  ...
  description:
    'Find where a symbol (class, function, variable) is defined in the codebase. ' +
    'Use when: you need to understand or modify a symbol — find its source first.',
  zodSchema: schema,
  ...
  metadata: {
    ...
    relatedTools: ['find-references', 'semantic-search'],
  },
  ...
  execute: async (args, onProgress) => {
    ...
    // Validate symbol as a safe identifier to prevent regex injection
