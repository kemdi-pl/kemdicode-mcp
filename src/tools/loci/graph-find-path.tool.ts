...
export const graphFindPathTool: UnifiedTool<typeof schema> = {
  ...
  description: 'Find paths between knowledge graph nodes. Use error-to-solution mode for fixes. Use when: tracing relationships (e.g., which solutions fix which errors).',
  zodSchema: schema,
