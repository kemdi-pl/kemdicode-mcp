...
export const invokeToolTool: UnifiedTool = {
  ...
  metadata: {
    ...
    examples: [
      { args: { toolName: 'find-definition', args: { symbol: 'Logger' }, agentId: 'backend-dev', sessionId: 'sess-abc123' }, description: 'Invoke find-definition from agent context' },
      { args: { toolName: 'error-pattern', args: { action: 'stats', limit: 10 }, agentId: 'qa', sessionId: 'sess-abc123', dryRun: true }, description: 'Check if agent can invoke error-pattern without executing' },
    ],
