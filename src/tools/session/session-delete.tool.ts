...
export const sessionDeleteTool: UnifiedTool<typeof schema> = {
  name: 'session-delete',
  description: 'Delete 1-10 sessions and optionally their context data. Use when: cleaning up finished or abandoned sessions.',
  zodSchema: schema,
  ...
  metadata: {
    ...
    examples: [
      ...
      { args: { sessions: [{ sessionId: 'session-a' }, { sessionId: 'session-b' }] }, description: 'Delete multiple sessions' },
    ],
