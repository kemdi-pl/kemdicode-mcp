...
export const sessionRecoverTool: UnifiedTool<typeof schema> = {
  ...
  metadata: {
    ...
    relatedTools: ['memory', 'smart-handoff', 'loci-recall', 'agent-rank', 'tool-health'],
  },
  ...
  execute: async (args, onProgress) => {
    ...
    try {
      ...
      recommendations.push('Save session state via: memory --action write --name active-session --content <state>');
