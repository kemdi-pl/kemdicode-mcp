...
/** Non-AI alternatives for AI-dependent tools */
const FALLBACK_MAP: Record<string, string[]> = {
  'semantic-search': ['file-search', 'find-definition', 'find-references'],
  'code-review': ['run-lint', 'check-types'],
  'explain-code': ['code-outline', 'find-symbols'],
  'fix-bug': ['file-read', 'file-diff', 'git-blame'],
  refactor: ['file-read', 'code-outline'],
  'write-tests': ['file-read', 'file-write'],
  'analyze-deps': ['project-info', 'file-tree'],
  'ask-ai': ['file-read', 'file-search'],
  plan: ['file-tree', 'project-info'],
  build: ['file-write', 'file-read'],
  brainstorm: ['file-read', 'shared-thoughts'],
  'auto-fix': ['replace-content', 'replace-lines'],
  'auto-fix-agent': ['auto-fix', 'replace-content'],
  'multi-prompt': ['ask-ai'],
