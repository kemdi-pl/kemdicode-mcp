...
/**
 * Lazy Tool Loader Registry — v4.7.0
 *
...
registerLazyTool({
  ...
  description:
    'Self-organizing recurring audit system: create schedules, auto-dispatch magistrale audits, self-assess findings, and feed results back via kanban',
  loader: () => import('./cluster-bus/index.js').then((m) => m.auditSchedulerTool),
});
