...
const schema = z.object({
  ...
  agent: z
    ...
    .default('plan')
    .describe('Agent or Mind: plan/build/explore/general + Nine Minds (socratic, ontologist, seed-architect, evaluator, contrarian, hacker, simplifier, researcher, architect)'),
