...
const startSchema = z.object({
  ...
  confidence: z.number().min(0).max(100).optional().default(50).describe('Confidence level (0-100%)'),
...
const reviseSchema = z.object({
  ...
  confidence: z.number().min(0).max(100).optional().default(50).describe('New confidence level (0-100%)'),
...
export const thinkingChainTool: UnifiedTool = {
  ...
  metadata: {
    ...
    relatedTools: ['graph-query', 'loci-recall', 'shared-thoughts', 'memory'],
  },
