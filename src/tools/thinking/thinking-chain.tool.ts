...
const startSchema = z.object({
  ...
  agentId: z.string().min(1).max(100).describe('Agent ID'),
...
export const thinkingChainTool: UnifiedTool = {
  name: 'thinking-chain',
  description:
    'Register and manage chains of thought with branching. Forward-only: cannot backtrack until ≥90% confidence or at last thought. Actions: start, think, branch, revise, conclude, get, list.',
  zodSchema: schema,
