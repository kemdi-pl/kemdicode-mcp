...
export const editMemoryTool: UnifiedTool = {
  name: 'edit-memory',
  description:
    'Edit 1-10 existing memories — update content or tags without deleting and recreating. ' +
    'Use when: information has changed and existing memories need updating.',
  zodSchema: schema,
  metadata: {
    category: 'memory',
