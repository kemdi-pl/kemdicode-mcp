...
export const agentRegisterTool: UnifiedTool = {
  ...
  metadata: {
    ...
    examples: [
      { args: { agents: [{ name: 'Backend Dev', role: 'worker', model: 'claude-sonnet-4-6' }], sessionId: 'sess-abc123', serverId: 'kemdicode-mcp' }, description: 'Register a single worker agent' },
