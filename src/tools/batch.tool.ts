...
export const batchTool: UnifiedTool<typeof schema> = {
  ...
  metadata: {
    ...
    examples: [
      ...
      { args: { operations: [{ tool: 'read-memory', args: { names: ['config'] } }, { tool: 'list-memories', args: { limit: 5 } }], parallel: true }, description: 'Read memory and list memories simultaneously' },
    ],
