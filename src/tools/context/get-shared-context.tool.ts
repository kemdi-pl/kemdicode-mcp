...
export const getSharedContextTool: UnifiedTool = {
  ...
  description: 'Get context shared by other MCP servers. Use when: accessing context shared by other MCP servers.',
  zodSchema: schema,
  ...
  metadata: {
    ...
    examples: [
      ...
      { args: { from_server: 'kemdicode-mcp', tool_name: 'decision-journal', limit: 5 }, description: 'Get last 5 decision journal entries from kemdicode-mcp' },
    ],
